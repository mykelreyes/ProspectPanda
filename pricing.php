                     ...
                     <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                           <div class="section__header text-center">
                              ...
                              <h2 class="title title-anim">Choose the plan that fits your business</h2>
                              <div class="paragraph">
                        ...
                        <div class="col-12 col-lg-8">
                           <div class="text-center">
                              <div class="alert alert-info">
                                 <i class="fa-solid fa-star"></i> Save 20% with annual billing
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-12 col-lg-10">
                           <div class="faq-wrapper">
                              ...
                              <div class="faq-item fade-top">
                                 ...
                                 <p>No setup fees. Ever. You only pay for your subscription.</p>
                              </div>
                              <div class="faq-item fade-top">
                     ...
                     <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                           <div class="cta__content text-center">
                              <h2 class="title title-anim">Ready to get started?</h2>
                              <p>Join thousands of companies using ProspectPanda to grow their business. Start your free trial today.</p>
                              <div class="section__content-cta">
               ...
               <section class="section next-page">
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                           <div class="section__header text-center">
                              <a href="contact.php" class="sub-title mb-0">
                                 Next Page
                                 <i class="fa-solid fa-arrow-right"></i>
                              </a>
                           </div>
